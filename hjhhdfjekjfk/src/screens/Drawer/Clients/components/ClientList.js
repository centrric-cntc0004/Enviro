...
import { View, Text,StyleSheet, FlatList, TextInput, TouchableOpacity, Alert, Image, ActivityIndicator } from 'react-native'
...
const ClientList = ({ get_certificate,temp_client_list, navigation, client_list, dispatch, search_employee
