            ...
            <SafeAreaView style={{ flex: 1, backgroundColor: mainWhite }}>
                ...
                <View style={{ flexDirection: "row", marginLeft: 10 }}>
                    ...
                    <View style={{ width: '20%', flexDirection: "column", }}>
                        ...
                        <View style={styles.editableBoxStyle}>
                            {job_card.service_list[0] ? (
                                <Text style={{height: 40, marginTop: 10}}
                                >{job_card.service_list[0].waste_type}</Text>
                            ) : (
                                    null
                                )}
                        ...
                        <View style={styles.editableBoxStyle}>
                            {job_card.service_list[1] ? (
                                <Text style={{height: 40, marginTop: 10}}
                                >{job_card.service_list[1].waste_type}</Text>
                            ) : (null)}
                        </View>
                        <View style={styles.editableBoxStyle}>
                            {job_card.service_list[2] ? (
                                <Text style={{height: 40, marginTop: 10}}
                                >{job_card.service_list[2].waste_type}</Text>
                            ) : (null)}
                        </View>
...
null
                    ...
                    <View style={{ width: '20%', flexDirection: "column", marginLeft: 10 }}>
                        ...
                        <View style={styles.editableBoxStyle}>
                            ...
                            {job_card.service_list[0] ? (
                                <Text style={{height: 40, marginTop: 10}}
                                >{job_card.service_list[0].capacity}</Text>
                            ) : (null)}
                        </View>
                        <View style={styles.editableBoxStyle}>
                            {job_card.service_list[1] ? (
                                <Text style={{height: 40, marginTop: 10}}
                                >{job_card.service_list[1].capacity}</Text>
                            ) : (null)}
                        </View>
                        <View style={styles.editableBoxStyle}>
                            {job_card.service_list[2] ? (
                                <Text style={{height: 40, marginTop: 10}}
                                >{job_card.service_list[2].capacity}</Text>
                            ) : (null)}
                        </View>
                    ...
                    <View style={{ width: '20%', flexDirection: "column", marginLeft: 10 }}>
                        ...
                        <View style={styles.editableBoxStyle}>
                            {job_card.service_list[0] ? (
                                <Text style={{height: 40, marginTop: 10}}
                                >{job_card.service_list[0].frequency}</Text>
                            ) : (null)}
                        ...
                        <View style={styles.editableBoxStyle}>
                            {job_card.service_list[1] ? (
                                <Text style={{height: 40, marginTop: 10}}
                                >{job_card.service_list[1].frequency}</Text>
                            ) : (null)}
                        ...
                        <View style={styles.editableBoxStyle}>
                            {job_card.service_list[2] ? (
                                <Text style={{height: 40, marginTop: 10}}
                                >{job_card.service_list[2].frequency}</Text>
                            ) : (null)}
                        </View>
                    </View>
                      ):(
null
                    ...
                    <View style={{ width: '20%', flexDirection: "column", marginLeft: 10 }}>
                        ...
                        <View style={styles.editableBoxStyle}>
                            {job_card.service_list[0] ? (
                                <Text style={{height: 40, marginTop: 10}}
                                >{job_card.service_list[0].pit_location}</Text>
                            ) : (null)}
                        </View>
                        <View style={styles.editableBoxStyle}>
                            {job_card.service_list[1] ? (
                                <Text style={{height: 40, marginTop: 10}} 
                                >{job_card.service_list[1].pit_location}</Text>
                            ) : (null)}
                        </View>
                        <View style={styles.editableBoxStyle}>
                            {job_card.service_list[2] ? (
                                <Text style={{height: 40, marginTop: 10}}
                                >{job_card.service_list[2].pit_location}</Text>
                            ) : (null)}
                        </View>
                    </View>
                        ):(
