...
import { add_employee, team_list, team_list_current1 } from '../action'
        ...
        return (
            <SafeAreaView style={{ flex: 1, }}>
                ...
                <ScrollView style={{ flex: 1,backgroundColor: mainWhite }}>
                    <View style={{ flex: 1, backgroundColor: mainWhite,marginTop:'7%' }}>
                        ...
                        <View style={{ justifyContent: 'center', alignItems: "center", borderRadius: 5, borderWidth: 0.25, borderColor: mainGrey, marginLeft: 10, marginRight: 10, flex: 1.9, paddingHorizontal: 20, backgroundColor: mediumGrey, flexDirection: 'row', }}>


                            <View style={{marginBottom:30, flex: 1.2, backgroundColor: mediumGrey, marginTop:15, justifyContent: 'center', alignItems: 'center' }}>
                                {image ? (
                                    <Image style={{ height: 80, width: 80, borderRadius: 40, }} source={profPic} />

                                ) : (
                                        <TouchableOpacity style={{ height: 80, width: 80, borderRadius: 40, justifyContent: 'center', alignItems: "center", backgroundColor: mainGrey }}
                            ...
                            {/* <View style={{marginTop:10, flex: 1.2, backgroundColor: mediumGrey, justifyContent:'center',alignItems:'center'}}>
                                {image ? (
                                    <Image style={{ height: 80, width: 80, borderRadius: 40,  }} source={profPic} />

                                ) : (
                                        <TouchableOpacity onPress={() => ProfilePictureAdd()}
                                            style={{  justifyContent: 'center', alignItems: 'center', height: 80, width: 80, borderRadius: 40, backgroundColor: mainGrey, flexDirection: 'column' }}  >
                                            <Icon name='person' color={mainWhite} size={25} />
                                            <Text style={{ color: mainWhite, fontSize: 12 }}>Add Image</Text>
                            ...
                            <View style={{
                                ...
                                <View style={{ flexDirection: 'row', }}>
                                    <Text style={{ paddingTop: 5, color: lightGreen, fontSize: 14, color: textBlue }}>Position Title :</Text>

                                    <View style={{ paddingTop: 5, marginLeft: 10, width: 100, }}>
                                        <Dropdown
                                ...
                                <View style={{ flexDirection: 'row' }}>
                                    ...
                                    <View style={{
                                        ...
                                        <TextInput
                                            ...
                                            style={{ color: textBlack, fontSize: 14, width: 100, height:40}}
                                            autoCapitalize='none'
                                            value={firstname}
                                            placeholder="Name"
