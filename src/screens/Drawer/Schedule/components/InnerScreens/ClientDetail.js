...
const ClientData = ({ navigation, route, dispatch, schedule_enviro }) => {
    ...
    const RenderContacts = () => {
        ...
        if (selected_client) {
            ...
            client_type=selected_client.client.client_type
            amount=selected_client.amount
            quote=selected_client.created_by
        ...
        if (selected_client) {
            if (selected_client.dp) {
                var profPic = { uri:  selected_client.dp };
                console.log(profPic)
            } else {
        ...
        const call_api_jobcard = () => {
            console.log("jobhggggggggggggggg"+JSON.stringify(selected_client.quote_id))
        ...
        const call_image=(rowData)=>{

         Linking.openURL(rowData.file)
        }
                    ...
                    <View style={{ flex: 1, flexDirection: 'row', }}>
                            ...
                            <View style={styles.editableBoxStyle}>
                                ...
                                <Text numberOfLines={1}
                                    style={{ color: mainGrey, fontSize: 14, alignSelf: 'center',paddingLeft:5  }}
                                   >{ClientName}
                                    </Text>
                            </View>
                        </View>
                        ...
                        <View style={{ flex: 1, flexDirection: 'row', }}>
                            ...
                            <Text style={{ alignSelf: 'center' }}>:</Text>
                                ...
                                <Text numberOfLines={1}
                                style={{ alignSelf: 'center', color: mainGrey, paddingLeft:5 }}>{ClientEmail}</Text>
                        ...
                        <View style={{ flex: 1, flexDirection: 'row', }}>
                            ...
                            <View style={styles.editableBoxStyle}>
                                ...
                                <Text numberOfLines={1}
                                style={{ alignSelf: 'center', color: mainGrey,paddingLeft:5  }}>{status}</Text>
                        ...
                        <View style={{ flex: 1, flexDirection: 'row', }}>
                            ...
                            <View style={styles.editableBoxStyle}>
                                <Text style={{ alignSelf: 'center' }}>:</Text>
                                <Text numberOfLines={1}
                                style={{ alignSelf: 'center', color: mainGrey,paddingLeft:5  }}>{amount}</Text>
                        ...
                        <View style={{ flex: 1, flexDirection: 'row', }}>
                            ...
                            <View style={styles.editableBoxStyle}>
                                ...
                                <Text numberOfLines={1}
                                style={{ alignSelf: 'center', color: mainGrey,paddingLeft:5  }}>{quote}</Text>
                ...
                {selected_client ? (
                                <FlatList  style={{backgroundColor:mainWhite}}
                                    ...
                                    renderItem={({ item: rowData }) => {
                                        return (
                                            <TouchableOpacity onPress={()=>call_image(rowData)}>
                                            <Image style={{ marginLeft: 20, width: width, height: width,resizeMode:'cover' }}
                                    ...
                                    <View>
                                        {selected_client.image!==null?(
                                            ...
                                            <Image style={{ marginLeft: 20, width: width, height: width }}
                                                source={{ uri: selected_client.image }} />
                                       </View>
                                        ):(
                                            null
                                        )}
