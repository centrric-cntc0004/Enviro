...
import { schedule_list, complete_schedule_list, select_type,complete_schedule_list1 } from '../common/action'
let date2 = ""
const ContentLayout1 = ({ navigation, schedule_enviro, dispatch }) => {
    ...
    const call_nextapi = (data) => {
        ...
        if (data === "Pumps") {
            ...
            dispatch(complete_schedule_list1(date2,"pumps"))
            ...
            dispatch(complete_schedule_list1(date2,"destruction"))
            ...
            dispatch(complete_schedule_list1(date2,"hills"))
            ...
            dispatch(complete_schedule_list1(date2,"waste"))
            ...
            dispatch(complete_schedule_list1(date2,"all"))
