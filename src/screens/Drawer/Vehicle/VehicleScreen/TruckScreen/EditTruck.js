...
const EditTruck = ({ navigation, route, all_truck_list, dispatch,companytypes }) => {
    ...
    const RenderContacts = () => {
        ...
        if (route.params) {
            ...
            if (route.params.items) {
                ...
                reg=route.params.items.registration
        ...
        const [indexData, setIndexData] = useState(reg)
 ...
 console.log("lkj"+JSON.stringify(route.params.items))
        ...
        const edit_maintenance = () => {
            ...
            // form_body.append('vehicle', route.params.items.vehicle)
