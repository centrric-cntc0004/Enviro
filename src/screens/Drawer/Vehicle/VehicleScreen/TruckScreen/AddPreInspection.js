...
const AddPreInspection = ({ navigation, vehicledata, route, all_truck_list, dispatch,companytypes }) => {
    const RenderContacts = () => {
        ...
        let dropdownData = []
        if (all_truck_list) {
            console.log("jagshdjasghsdj" + JSON.stringify(all_truck_list))
...
const mapStateProps = (state) => {
    const { truck_preinspection_list, all_truck_list,companytypes } = state.vehicle__truck
    return { all_truck_list ,companytypes}
}
