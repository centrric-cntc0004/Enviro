...
import { mainWhite, darkGrey, mainBlack, mainGrey, lightGrey, lightGreen, mainBlue, mediumGrey, textlightgrey } from '../../../../../common/Colors'
...
const AddTruck = ({ navigation, route,dispatch ,maintanace_create,companytypes}) => {
    ...
    const RenderContacts = () => {
        ...
        return (
            ...
            <ScrollView showsVerticalScrollIndicator={false}
                ...
                <View style={{ paddingBottom: 60, flex: 1, paddingHorizontal: 20, backgroundColor: mainWhite, }}>
                    ...
                    <View style={{ flex: 8, backgroundColor: mainWhite, flexDirection: 'column', borderWidth: 0.2, borderColor: darkGrey, borderRadius: 1, marginTop: '9%', height: 510, }}>
...
export default connect(mapStateProps,mapDispatchToProps)(AddTruck)
