...
import Checkboxadd from '../TruckScreen/Innerscreen/Checkboxadd'
import CheckBoxReview from './InnerScreen/CheckBoxReview'
import CheckBoxCategory from './InnerScreen/CheckBoxCategory'

import DatePicker from 'react-native-datepicker'
 import VehicleSelect from './InnerScreen/VehicleSelect'
 import { connect } from 'react-redux'
import { __create_preinspection, fetch_all_truck_list ,fetch_preinspection_list} from './common/action'
import Icon1 from 'react-native-vector-icons/FontAwesome5'
import Toast from 'react-native-simple-toast';



const AddInspection = ({ navigation, vehicledata, route,all_forklift_list, dispatch,companytypes }) => {
    const RenderContacts = () => {
        ...
        let dropdownData = []
        if (all_forklift_list) {
            console.log("jagshdjasghsdj" + JSON.stringify(all_forklift_list))
            all_forklift_list.map((item) => {
        ...
        const [indexData, setIndexData] = useState(all_forklift_list[0].id)
        ...
        const submit_form = () => {
            ...
            form_body.append("driver_name", 12)
            ...
            form_body.append("fire_extinguisher_date", fire)
            ...
            form_body.append('safe_ready_to_operate', isCheck30)

            // form_body.append("reported_faults", isCheck30)
            form_body.append("reported_faults", isCheck31)

            form_body.append("reviewed_form", isCheck31)
            form_body.append("corrected", isCheck35)
            form_body.append("scheduled_for_repair", isCheck37)

            form_body.append("no_action", isCheck36)
            form_body.append('vehicle_type', 'fork-lift')
            form_body.append('tab_type',companytypes.name)
        ...
        return (
            <ScrollView showsVerticalScrollIndicator={false}
                ...
                <View style={{ paddingHorizontal: 20, flex: 1, backgroundColor: lightGrey, marginTop: '1%', paddingBottom: 60 }}>
                    ...
                    <View style={{ flex: 2, backgroundColor: lightGrey, height: 200, marginTop: 20, }}>
                        ...
                        <View style={{ flex: 1, flexDirection: 'row', }}>
                            ...
                            <View style={styles.editableBoxStyle}>
                                ...
                                <Text style={{ paddingLeft: 5, alignSelf: 'center', color: darkGrey }}>{date}</Text>
                                {/* <DatePicker
                                    style={{
                                        width: 90,
                            ...
                            <View style={{ height: 25 }}>
                                <View style={{ flex: 1, flexDirection: 'row' }}>
                                    ...
                                    <View style={{ flex: 13, flexDirection: "row" }}>
                                        <Text style={{ fontSize: 14, color: mainGrey, alignSelf: 'center' }}>Appropriate PPE for operation of this Vehicle</Text>
                                        <Icon1 style={{ alignSelf: 'center', marginLeft: 5, marginBottom: 5 }} size={8} color="red" name="star-of-life"></Icon1>
                    ...
                    <View style={{ flex: 1, backgroundColor: lightGrey, flexDirection: 'column', marginTop: 30 }}>
                        ...
                        <View style={{ height: 30, backgroundColor: lightGrey, marginTop: 5, flexDirection: 'row' }}>
                            ...
                            <View style={{ flex: 0.5, backgroundColor: lightGrey }}>
                                <CheckBoxCategory checked={isCheck3} state={setCheck3} />
                            </View>
                        </View>
                        <View style={{ height: 30, backgroundColor: lightGrey, marginTop: 5, flexDirection: 'row' }}>
                            <View style={{ flex: 1.2, backgroundColor: lightGrey }}>
                            ...
                            <View style={{ flex: 0.5, backgroundColor: lightGrey }}>
                                <CheckBoxCategory checked={isCheck4} state={setCheck4} />
                            </View>
                        </View>
                        <View style={{ height: 30, backgroundColor: lightGrey, marginTop: 5, flexDirection: 'row' }}>
                            <View style={{ flex: 1.2, backgroundColor: lightGrey }}>
                            ...
                            <View style={{ flex: 0.5, backgroundColor: lightGrey }}>
                                <CheckBoxCategory checked={isCheck5} state={setCheck5} />
                            </View>
                        </View>
                        <View style={{ height: 30, backgroundColor: lightGrey, marginTop: 5, flexDirection: 'row' }}>
                            <View style={{ flex: 1.2, backgroundColor: lightGrey }}>
                            ...
                            <View style={{ flex: 0.5, backgroundColor: lightGrey }}>
                                <CheckBoxCategory checked={isCheck6} state={setCheck6} />
                            </View>
                        </View>
                        <View style={{ height: 30, backgroundColor: lightGrey, marginTop: 5, flexDirection: 'row' }}>
                            <View style={{ flex: 1.2, backgroundColor: lightGrey }}>
                            ...
                            <View style={{ flex: 0.5, backgroundColor: lightGrey }}>
                                <CheckBoxCategory checked={isCheck7} state={setCheck7}
                                />
                            </View>
                        </View>
                        <View style={{ height: 30, backgroundColor: lightGrey, marginTop: 5, flexDirection: 'row' }}>
                            ...
                            <View style={{ flex: 0.5, backgroundColor: lightGrey }}>
                                <CheckBoxCategory checked={isCheck8} state={setCheck8} />
                            </View>
                        </View>
                        <View style={{ height: 30, backgroundColor: lightGrey, marginTop: 5, flexDirection: 'row' }}>
                            <View style={{ flex: 1.2, backgroundColor: lightGrey }}>
                            ...
                            <View style={{ flex: 0.5, backgroundColor: lightGrey }}>
                                <CheckBoxCategory checked={isCheck9} state={setCheck9} />
                            </View>
                        </View>
                        <View style={{ height: 30, backgroundColor: lightGrey, marginTop: 5, flexDirection: 'row' }}>
                            <View style={{ flex: 1.2, backgroundColor: lightGrey }}>
                            ...
                            <View style={{ flex: 0.5, backgroundColor: lightGrey }}>
                                <CheckBoxCategory checked={isCheck10} state={setCheck10} />
                            </View>
                        </View>
                        <View style={{ height: 30, backgroundColor: lightGrey, marginTop: 5, flexDirection: 'row' }}>
                            <View style={{ flex: 1.2, backgroundColor: lightGrey }}>
                            ...
                            <View style={{ flex: 0.5, backgroundColor: lightGrey }}>
                                <CheckBoxCategory checked={isCheck11} state={setCheck11} />
                            </View>
                        </View>
                        <View style={{ height: 30, backgroundColor: lightGrey, marginTop: 5, flexDirection: 'row' }}>
                            <View style={{ flex: 1.2, backgroundColor: lightGrey }}>
                            ...
                            <View style={{ flex: 0.5, backgroundColor: lightGrey }}>
                                <CheckBoxCategory checked={isCheck12} state={setCheck12} />
                            </View>
                        </View>
                        <View style={{ height: 30, backgroundColor: lightGrey, marginTop: 5, flexDirection: 'row' }}>
                            <View style={{ flex: 1.2, backgroundColor: lightGrey }}>
                            ...
                            <View style={{ flex: 0.5, backgroundColor: lightGrey }}>
                                <CheckBoxCategory checked={isCheck13} state={setCheck13} />
                            </View>
                        </View>
                        <View style={{ height: 30, backgroundColor: lightGrey, marginTop: 5, flexDirection: 'row' }}>
                            <View style={{ flex: 1.2, backgroundColor: lightGrey }}>
                            ...
                            <View style={{ flex: 0.5, backgroundColor: lightGrey }}>
                                <CheckBoxCategory checked={isCheck14} state={setCheck14} />
                            </View>
                        </View>
                        <View style={{ height: 30, backgroundColor: lightGrey, marginTop: 5, flexDirection: 'row' }}>
                            <View style={{ flex: 1.2, backgroundColor: lightGrey }}>
                            ...
                            <View style={{ flex: 0.5, backgroundColor: lightGrey }}>
                                <CheckBoxCategory checked={isCheck15} state={setCheck15} />
                            </View>
                        </View>
                        <View style={{ height: 30, backgroundColor: lightGrey, marginTop: 5, flexDirection: 'row' }}>
                            <View style={{ flex: 1.2, backgroundColor: lightGrey }}>
                            ...
                            <View style={{ flex: 0.5, backgroundColor: lightGrey }}>
                                <CheckBoxCategory checked={isCheck16} state={setCheck16} />
                            </View>
                        </View>
                        ...
                        <View style={{ height: 30, backgroundColor: lightGrey, marginTop: 5, flexDirection: 'row' }}>
                            ...
                            <View style={{ flex: 0.5, backgroundColor: lightGrey }}>
                                <CheckBoxCategory checked={isCheck17} state={setCheck17} />
                            </View>
                        </View>
                        <View style={{ height: 30, backgroundColor: lightGrey, marginTop: 5, flexDirection: 'row' }}>
                            <View style={{ flex: 1.2, backgroundColor: lightGrey }}>
                            ...
                            <View style={{ flex: 0.5, backgroundColor: lightGrey }}>
                                <CheckBoxCategory checked={isCheck18} state={setCheck18} />
                            </View>
                        </View>
                        <View style={{ height: 30, backgroundColor: lightGrey, marginTop: 5, flexDirection: 'row' }}>
                            <View style={{ flex: 1.2, backgroundColor: lightGrey }}>
                            ...
                            <View style={{ flex: 0.5, backgroundColor: lightGrey }}>
                                <CheckBoxCategory checked={isCheck19} state={setCheck19} />
                            </View>
                        </View>
                        <View style={{ height: 30, backgroundColor: lightGrey, marginTop: 5, flexDirection: 'row' }}>
                            <View style={{ flex: 1.2, backgroundColor: lightGrey }}>
                            ...
                            <View style={{ flex: 0.5, backgroundColor: lightGrey }}>
                                <CheckBoxCategory checked={isCheck20} state={setCheck20} />
                            </View>
                        </View>
                        <View style={{ height: 30, backgroundColor: lightGrey, marginTop: 5, flexDirection: 'row' }}>
                            <View style={{ flex: 1.2, backgroundColor: lightGrey }}>
                            ...
                            <View style={{ flex: 0.5, backgroundColor: lightGrey }}>
                                <CheckBoxCategory checked={isCheck40} state={setCheck40} />
                            </View>
                        </View>
                        <View style={{ height: 30, backgroundColor: lightGrey, marginTop: 5, flexDirection: 'row' }}>
                            <View style={{ flex: 1.2, backgroundColor: lightGrey }}>
                            ...
                            <View style={{ flex: 0.5, backgroundColor: lightGrey }}>
                                <CheckBoxCategory checked={isCheck41} state={setCheck41} />
                            </View>
                        </View>
                        <View style={{ height: 30, backgroundColor: lightGrey, marginTop: 5, flexDirection: 'row' }}>
                            <View style={{ flex: 1.2, backgroundColor: lightGrey }}>
                            ...
                            <View style={{ flex: 0.5, backgroundColor: lightGrey }}>
                                <CheckBoxCategory checked={isCheck42} state={setCheck42} />
                            </View>
                        </View>
                        <View style={{ height: 30, backgroundColor: lightGrey, marginTop: 5, flexDirection: 'row' }}>
                            <View style={{ flex: 1.2, backgroundColor: lightGrey }}>
                            ...
                            <View style={{ flex: 0.5, backgroundColor: lightGrey }}>
                                <CheckBoxCategory checked={isCheck43} state={setCheck43} />
                            </View>
                        </View>
                        <View style={{ height: 30, backgroundColor: lightGrey, marginTop: 5, flexDirection: 'row' }}>
                            <View style={{ flex: 1.2, backgroundColor: lightGrey }}>
                            ...
                            <View style={{ flex: 0.5, backgroundColor: lightGrey }}>
                                <CheckBoxCategory checked={isCheck44} state={setCheck44} />
                            </View>
                        </View>
                        <View style={{ height: 30, backgroundColor: lightGrey, marginTop: 5, flexDirection: 'row' }}>
                            <View style={{ flex: 1.2, backgroundColor: lightGrey }}>
                            ...
                            <View style={{ flex: 0.5, backgroundColor: lightGrey }}>
                                <CheckBoxCategory checked={isCheck45} state={setCheck45} />
                            </View>
                        </View>
                    ...
                    <View style={{ flex: 2, backgroundColor: lightGrey, marginTop: 10 }}>
                        ...
                        <View style={{ flex: 2, backgroundColor: lightGrey, flexDirection: 'row' }}>
                            ...
                            <View style={{ flex: 1, backgroundColor: lightGrey, flexDirection: 'column' }}>
                                ...
                                <View style={{ height: 30, backgroundColor: lightGrey, marginTop: 5, flexDirection: 'row' }}>
                                    <View style={{ flex: 1.2, backgroundColor: lightGrey, flexDirection: 'row' }}>
                                        ...
                                        <DatePicker
                                            ...
                                            onDateChange={(date) => { setFire(date) }}
                    ...
                    <View style={{ flex: 2, height: 80, backgroundColor: '#F8F189', flexDirection: 'column' }}>
                        <Text style={{ paddingLeft: 10 }} >Any Faults to Report (of any Category) & any additional information</Text>
                        <TextInput
                            underlineColorAndroid="transparent"
                            style={{ paddingLeft: 5, color: darkGrey, }}
                            autoCapitalize='none'
                            value={addInfo}
                            placeholder="Type here..."
                            onChangeText={txt => setAddInfo(txt)}
                        />
                    </View>
                    ...
                    <View style={{ flex: 1, backgroundColor: "#c3edf6", marginTop: '10%', paddingHorizontal: 10 }}>
                        ...
                        <View style={{ flex: 0.3, paddingTop: 20, backgroundColor: "#c3edf6", flexDirection: 'row', height: 90 }}>
                            ...
                            <View style={{ flexDirection: 'column' }}>
                                <Text style={{ paddingHorizontal: 10, fontSize: 14, color: textBlack, opacity: 1 }}>I have reviewed this form and satisfied that </Text>
                                <Text style={{ paddingHorizontal: 10, fontSize: 14, color: textBlack, opacity: 1 }}>required maintenance or safety related items</Text>

                                <View style={{ flexDirection: 'row' }}>
                                    <Text style={{ paddingHorizontal: 10, fontSize: 14, color: textBlack, opacity: 1 }}> have been addressed.</Text>
                                    <Icon1 style={{ alignSelf: 'center' }} size={8} color="red" name="star-of-life"></Icon1>
                                </View>
                            </View>
                        </View>
                        <View style={{ flex: 0.5, backgroundColor: "#c3edf6", flexDirection: 'column' }}>
                            ...
                            <View style={{ flex: 0.5, backgroundColor: "#c3edf6", flexDirection: 'row', height: 50, }}>
                                ...
                                <Text style={{ paddingHorizontal: 10, fontSize: 14, color: textBlack, opacity: 1 }}>Issues scheduled for maintenance or repair do not affect the safe operation of this vehicle</Text>
                            </View>
                        </View>
                    ...
                    <Text>Date</Text>
                        ...
                        <View style={{ flex: 0.5, backgroundColor: "#c3edf6" }}>
                            <View style={{ flex: 2.5, marginTop: '7%', flexDirection: 'row', height: 40 }}>
                                <View style={{ flex: 0.2 }} />
...
const mapStateProps = (state) => {
    const { all_forklift_list } = state.vehicle__forklift
    const { companytypes} = state.vehicle__truck

    return { all_forklift_list,companytypes }
}

export default connect(mapStateProps)(AddInspection)
