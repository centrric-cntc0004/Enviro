...
import { View, StyleSheet, KeyboardAvoidingView, Text, TextInput, TouchableOpacity, ScrollView,ActivityIndicator ,Alert} from 'react-native'
...
const AddExpense = ({ navigation, route ,dispatch,companytypes}) => {
...
export default connect(mapStateProps)(AddExpense)
