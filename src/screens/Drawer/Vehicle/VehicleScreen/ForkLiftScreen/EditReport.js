...
const EditReport = ({ navigation, route, dispatch ,companytypes}) => {
    ...
    const RenderContacts = () => {
        ...
        if (route.params) {
            if (route.params.items) {
                ...
                ids=route.params.items.vehicle
        ...
        const [indexData, setIndexData] = useState(ids)
        ...
        if (indexData !== ids || descriptions !== descriptionnew ||
...
const mapStateToProps = (state) => {
    ...
    return { forklift_maintanace_list, forklift_maintanance_page, all_forklift_list,companytypes }
