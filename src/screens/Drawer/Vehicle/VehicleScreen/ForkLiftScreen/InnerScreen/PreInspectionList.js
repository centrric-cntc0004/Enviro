...
const PreInspectionList = ({ navigation, data,tabtypes, vehicledata ,truck_preinspection_list,companytypes}) => {
    const RenderContacts = () => {
       ...
       useEffect(() => {
        ...
        const fetch_api_call = () => {
            ...
            let get_url = VEHICLE_GET +  companytypes.name+ '/'+tab+'/pre-inspection/'+pageNo+'/'       
        ...
        const RenderList = ({ item }) => {
            ...
            return (
                ...
                onPress={() => navigation.navigate('editinspection', { items: item, vehicleList: vehicledata })}
                    style={{
...
const mapStateProps = (state) => {
    const { truck_preinspection_list  } = state.vehicle__forklift
    const { companytypes,tabtypes  } = state.vehicle__truck

    return {truck_preinspection_list,companytypes,tabtypes}
}
