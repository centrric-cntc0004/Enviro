    ...
    return (
        ...
        <ScrollView style={{ backgroundColor: lightGrey }}
            ...
            <View style={{ flex: 0.1, marginBottom: 10, }}>
                ...
                <IntranetNewFolders APIURL={`${VEHICLE_FOLDER_LIST}${"fork-lift/"}${vehicle_data.id}/`} title={'Accounts'} FILEEDIT={VEHICLE_FILE_EDIT}
                    ...
                    id={route.params.id} name={route.params.name}SELETPATH={"vehicle_forklift"} SELECTID={vehicle_data.id}/>
            </View>
        </ScrollView>
...
const mapStateProps = (state) => {
    const { vehicle_data } = state.vehicle__truck
