...
const cars = (state = initialState, actions) => {
    switch (actions.type) {
        case "TRUCK_FETCHING":
            return {
                ...state,
        ...
        case "CAR_MAINTANACE_LIST":
            return {
                ...state,
                car_maintanace_list: actions.maintanace,
                truck_maintanance_page: actions.page,
                isLoading: false
            }
        case "CAR_PREINSPECTION_LIST":
            return {
                ...state,
        ...
        case "CAR_FUEL_LIST":
            return {
                ...state,
                car_fuel_list: actions.fuellist,
