       ...
       let data=[]
        ...
        const RenderList = ({ item }) => {
            ...
            return (
                ...
                onPress={() => navigation.navigate('editpreinspections', { items: item, vehicleList: vehicledata })}
                    style={{
        ...
        if (truck_preinspection_list.length < 1)
            return (
...
const mapStateProps = (state) => {
    const { truck_preinspection_list  } = state.vehicle_cars
