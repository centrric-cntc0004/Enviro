...
import { BASE_IMAGE_URL, FILES_FOLDERS_SEARCH,FILES_FOLDERS_SEARCHS, FILES_FILE_SEARCH, OHS_AND_S_FOLDERS,ACCOUNTS_FILES_FOLDER_GET
...
const AccountsMain = ({ navigation, intranet_enviro, dispatch }) => {
    ...
    return (
        <ScrollView style={{ backgroundColor: lightGrey }}
            ...
            <View style={{ flex: 1, paddingHorizontal: 10, backgroundColor: lightGrey, marginBottom: 40 }}>
                ...
                <MainFolder navigation={navigation} APIURL={ACCOUNTS_FILES_FOLDER_GET}
               FOLDEREDIT={INTRANET_FOLDER_EDIT} FOLDERADD={OHS_AND_S_FILE_ADD} FOLDERCREATE={ACCOUNTS_FOLDER_CREATE} 
               FOLDERDELETE={OHS_AND_S_FOLDER_DELETE} SELETPATH={"accounts"} />
...
export default connect(mapStateProps)(AccountsMain)
