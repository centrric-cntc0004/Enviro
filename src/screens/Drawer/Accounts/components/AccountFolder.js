...
import {
    INTRANET_FOLDERS_EDIT, INTRANET_FILE_DELETE, ACCOUNTS_FILES_FOLDER_GET, INTRANET_FILE_ADD, INTRANET_FILE_CREATE, OHS_AND_S_FILE_ADD, OHS_AND_S_FOLDER_DELETE, INTRANET_FOLDER_EDIT, INTRANET_FOLDERS_CREATE,
...
const AccountFolder = ({ navigation, route, intranet_enviro, dispatch }) => {
    ...
    return (
        ...
        <ScrollView style={{ backgroundColor: lightGrey }}
            ...
            <View style={{ flex: 0.1, marginBottom: 10, }}>
                ...
                <IntranetNewFolders APIURL={ACCOUNTS_FILES_FOLDER_GET} title={'Accounts'} FILEEDIT={INTRANET_FILES_RENAME}
...
export default connect(mapStateProps)(AccountFolder)
