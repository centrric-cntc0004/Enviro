...
import { fetch_notify_list, create_notify, delete_notify, fetch_member_list, read_notify ,select_data} from '../../Drawer/Projections/common/actions'
...
const Notifications = ({ navigation, notification_list, isLoading, dispatch, team_list, memberarray }) => {
    ...
    const onNextNavigate = (item) => {
        ...
        navigation.navigate("enviro-noficationdetail", { items: item })
    }
        ...
        return (
            ...
            refreshControl={
                ...
                <View style={{ flex: 1, backgroundColor: mainWhite }}>
                    <View style={{ height: 10, backgroundColor: mainWhite }}>
