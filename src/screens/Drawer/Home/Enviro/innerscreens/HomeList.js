...
let profile_permission =
 { "tabs": { "home": true, "ohs_s": true, "sales": true, "intranet": true, "Schedule": true, "client": true, "team": true, "vehicle": true }, "vehicle": { "add": true, "eidt": true, "delete": true } }
...
const HomeList = ({ navigation }) => {
    ...
    const RenderContacts = ({ navigation }) => {
        ...
        { "type": "Accounts", "name": "account-balance", "opacity": profile_permission.tabs.team }]
