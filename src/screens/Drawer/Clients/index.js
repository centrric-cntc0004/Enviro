...
import { fetch_client_list,fetch_client_list_init,fetch_temp_clients,get_asset,select_type_data ,select_location_data} from './action'
...
function EnviroClients({client, fetch_clients, ownProps, searchQuery ,fetch_temp_client,set_type,set_loc}) {
    ...
    return (
        ...
        >
            ...
            />
            <Stack.Screen name="clientProfileedit" component={ClientProfileEdit}
                options={{
                    title: '',
                    headerLeft: (props) => (<HeaderBackIcon {...props} page="clientProfile" />),
                    headerBackground: () => (<Header title="Site Profile" />)
...
const mapDispatchToProps = dispatch => {
    return {
        fetch_clients: (type) => dispatch(fetch_client_list(type)),
