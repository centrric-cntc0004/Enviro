...
import { ProfileDataEdit } from './Innerscreens'
const ClientProfileEdit = ({ navigation, route, client, }) => {
                    ...
                    {Object.keys(selected_client).length === 0 ? (
                        <View style={{ marginTop: 300, justifyContent: 'center', alignItems: 'center' }}>
                            ...
                            <View style={{ flex: 1, backgroundColor: lightGrey }}>
                                ...
                                <ProfileDataEdit navigation={navigation} />
                            </View>
                        )}
                </SafeAreaView>
...
export default connect(mapStateToProps)(ClientProfileEdit)
