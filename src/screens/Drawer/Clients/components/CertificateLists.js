...
import {certificate_list3} from '../../../Drawer/Team/action'
import { connect } from 'react-redux'
import {BASE_IMAGE_URL} from '../../../../store/endpoint'

const CertificateLists = ({ navigation, values, data,dispatch ,team,client}) => {
...
<View style={{ flex: 1, backgroundColor:lightGreyBackground, height: 50 }}>
                ...
                <Text style={{ paddingLeft: 10,paddingTop:15, color: textBlack }}>Employees Files</Text>
            </View>
...
const mapPropState = (state) => {
    const {client, team, all_folders } = state
    return {client, team, all_folders }
}
export default connect(mapPropState)(CertificateLists)
