...
const ProfileData = ({ navigation, client ,team}) => {
    ...
    const RenderContacts = () => {
        ...
        let purchaseno = ""
        if (selected_client) {
            console.log("selected_client"+JSON.stringify(selected_client.location_logitude))
        ...
        if (selected_client.location_logitude !== null &&
            ...
            selected_client.location_latitude !== null ) {
                console.log("selected_enter1"+JSON.stringify(selected_client.location_logitude))
            ...
            console.log("selected_enter11"+JSON.stringify(selected_client.location_logitude))

            select_location_data(user_location)

        } else {
            console.log("selected_data"+JSON.stringify(selected_client.location_logitude))
        ...
        return (
            <View style={{ flex: 1, backgroundColor: lightGrey }}>
                <View style={{ flex: 2.5, marginTop: '7%', flexDirection: 'row', height: 80 }}>
                    <View style={{marginLeft:"15%", flexDirection:'row', backgroundColor:"red", flex: 1.2, marginTop: 10, justifyContent: 'center', alignItems: 'center' }}>
...
{/* 
                            ...
                            <TouchableOpacity onPress={() => navigation.navigate('clientProfileedit')}
                            style={{marginLeft:'60%', width: 80, height: 40,   backgroundColor: lightGrey,  }}>
