...
export const FILES_FOLDERS_SEARCH2=BASE+'drive/search/folder'
export const FILES_FOLDERS_SEARCHS=BASE+'drive/search/folder/'
...
export const VEHICLE_GET = BASE + 'vehicles/' 
export const VEHICLE_ALL_GET = BASE + 'vehicles/' 
...
export const VEHICLE_TRUCK_MAINTANACE_GET = BASE + 'vehicles/'    
export const VEHICLE_TRUCK_MAINTANACE_SEARCH = BASE + 'vehicles/maintenace/reports/truck/search/'   
export const VEHICLE_TRUCK_MAINTANACE_EDIT = BASE + 'vehicles/' 
export const VEHICLE_CAR_MAINTANACE_EDIT = BASE + 'vehicles/maintenance/report/car/edit/'  
export const VEHICLE_CAR_MAINTANACE_DELETE= BASE + 'vehicles/'   


export const VEHICLE_TRUCK_MAINTANACE_DELETE = BASE + 'vehicles/' 
...
export const VEHICLE_TRUCK_FUEL_GET = BASE + 'vehicles/' 
export const VEHICLE_TRUCK_FUEL_EDIT = BASE + 'vehicles/' 
...
export const VEHICLE_FORKLIFT_MAINTANACE_GET = BASE + 'vehicles/' // append page no
...
export const VEHICLE_FORKLIFT_MAINTANACE_DELETE = BASE + 'vehicles/'
export const VEHICLE_FORKLIFT_MAINTANACE_ADD = BASE + 'vehicles/forklift/maintenance/report/create/'

export const VEHICLE_FOLDER_LIST=BASE+'drive/view/vehicle/folder/'
export const VEHICLE_FOLDER_CREATE=BASE+'drive/create/vehicle/folder/'
export const VEHICLE_FOLDER_RENAME=BASE+'drive/folder/rename/'
export const VEHICLE_FOLDER_DELETE=BASE+'drive/folder/delete/'

export const VEHICLE_FILE_CREATE=BASE+'drive/file/create/'
export const VEHICLE_FILE_EDIT=BASE+'drive/file/rename/'
export const VEHICLE_FILE_DELETE=BASE+'drive/file/delete/'
...
export const INTRANET_FOLDERS_CREATE = BASE + 'sales/folder/intranet/create/'
export const INTRANET_FOLDERS_EDIT = BASE + 'drive/folder/rename/'
export const INTRANET_FOLDERS_DELETE = BASE + 'drive/folder/delete/'
export const INTRANET_FILE_CREATE = BASE + 'drive/file/create/'
export const INTRANET_FILE_DELETE = BASE + 'drive/file/delete/'
export const INTRANET_FILE_EDIT = BASE + 'drive/file/rename/'

// export const INTRANET_FOLDERS_SEARCH = BASE + 'drive/search/folder/'
export const FILES_FOLDERS_SEARCH1       = BASE + 'drive/search/'
...
export const SCHEDULE_JOB_CARD1 = BASE + 'jobs/card/info/view/'
...
export const SCHEDULE_DETAILS=BASE+'sales/client/quote/'
...
export const TEAM_FILES_CREATE = BASE + 'drive/team/add/files/'
...
export const OHS_AND_S=BASE+'oh_and_s/folder/segment/list/'
export const CLIENT_TEMP_SERACH=BASE+'clients/temporary-client/search/'