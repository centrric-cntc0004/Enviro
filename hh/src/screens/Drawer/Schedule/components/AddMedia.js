    ...
    return (
        <ScrollView style={{ flex: 1 }}>
            <View style={{ flex: 0.3, }}>
                ...
                <View style={{ flex: 0.6, paddingHorizontal: 10, marginBottom: 30 }}>
                    <Text>Comments</Text>
                    <View style={{ flexDirection: 'row', marginTop: 10, paddingHorizontal: 10, borderRadius: 20, backgroundColor: "#E0E0E0", height: 45 }}>
                        <TextInput
                            underlineColorAndroid="transparent"
                            style={{ color: mainGrey, fontSize: 14, width: "90%" }}
                            autoCapitalize='none'
                            multiline={true}
                            value={comment}
                            numberOfLines={3}
                        ...
                        <View>
                            {
                                comment_data.map((item1, key) => {
                                    ...
                                    return (
                                        <TouchableOpacity
                                            style={{
                                                flexDirection: 'column', borderRadius: 20, height: 130,
                                            ...
                                            <View style={{ marginBottom: 10, flexDirection: 'column', flex: 1, backgroundColor: mainWhite, marginTop: 10, marginLeft: 5, marginRight: 5, }}>
                                                ...
                                                <View style={{ backgroundColor: mainWhite, flex: 4, marginRight: 10, flexDirection: 'column', }}>
                                                    <Text style={{ color: mainGrey, fontSize: 14, marginTop: 10, paddingLeft: 20, }}>{item1.comment}</Text>
                                                </View>
                                                <View style={{ flexDirection: 'row' }}>
                                                    <View style={{ flex: 0.9 }} />
                                                    <View style={{ flexDirection: 'row' }}>
