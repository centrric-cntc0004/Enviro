...
const AddDetails = ({ navigation, data, clientdata, client, dispatch }) => {
    ...
    const RenderContacts = () => {
        ...
        if (data.client_name !== selected_client.client_name ||
        ...
        const editProfile = () => {
            ...
            data1.append('location_latitude', selected_client.location_latitude);
            data1.append('location_logitude', selected_client.location_logitude);
...
editable={false}
                ...
                {/* {edit_btn_status && !userEmailAlert && !userNameAlert && email!==null && invoiceE!==null ? (
