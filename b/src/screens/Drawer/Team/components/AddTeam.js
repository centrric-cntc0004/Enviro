...
import { StyleSheet, View, Text, Image, SafeAreaView, TouchableOpacity, Dimensions, TextInput, ScrollView } from 'react-native'
...
const AddTeam = ({ route, navigation, dispatch, team }) => {
    ...
    const RenderContacts = () => {
        ...
        if (empid !== "" && image !== "" && firstname !== "" && contactno !== "" && docname !== "" && email !== ""  && password !== "" && dob !== "" && datejoin !== "" && expirydate !== "" && docuri !== "" && licencealert !== ""
        ...
        const submit_btn = () => {
            ...
            const failed = (response) => {
                console.log("response"+JSON.stringify(response))
                 Toast.showWithGravity(response.data.app_data, Toast.SHORT, Toast.BOTTOM);
