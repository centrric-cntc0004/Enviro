...
const Projection = ({fetch_news_data, read_new_data, navigation, create_news_fx, news_list, memberarray, isLoading, team_list_fx, team_list, fetch_member }) => {
...
const mapStateToProps = (state) => {
    ...
    return { news_list, isLoading, team_list, memberarray }
