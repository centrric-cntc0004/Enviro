...
const Joblist = ({ navigation, dispatch, sale_performance, sale_prfrm_month, sale_prfrm_year, }) => {
    ...
    let data = [
        ...
        {
            "name": "Jithin Test2", "won": 0, "lost": 0, "pending": 0, "total": 0,
            "profile": "/media/uploads/employee/dp/dp_zopwxNB.jpg", "id": 115
        },
        {
            "name": "Alexa Solu", "won": 0, "lost": 0, "pending": 0, "total": 0,
            "profile": "/media/uploads/employee/dp/dp_EVik8Bx.jpg", "id": 114
        },
        {
            "name": "Ejas Muhammed Driver", "won": 0, "lost": 0, "pending": 0,
            "total": 0, "profile": "/media/uploads/employee/dp/Screenshot_2021-02-13_at_11.49.54.png", "id": 113
        }, { "name": "Ejas Muhammed", "won": 0, "lost": 0, "pending": 0, "total": 0, "profile": "/media/uploads/employee/dp/dp.jpg", "id": 112 }, { "name": "test", "won": 0, "lost": 0, "pending": 0, "total": 0, "profile": "/media/uploads/employee/dp/image_CO9llXh.jpg", "id": 111 }, { "name": "EZED Developer", "won": 0, "lost": 0, "pending": 0, "total": 0, "profile": "/media/uploads/employee/dp/user-dp_raI0tzk.jpeg", "id": 107 }, { "name": "Enviro Tech Team2", "won": 0, "lost": 0, "pending": 0, "total": 0, "profile": "/media/uploads/employee/dp/IMG_6177_p2w6BwL.jpg", "id": 98 }, { "name": "Development Team", "won": 0, "lost": 0, "pending": 0, "total": 0, "profile": "/media/uploads/employee/dp/kid_njxU4oC.jpg", "id": 97 }, { "name": "Simon Saba", "won": 0, "lost": 0, "pending": 0, "total": 0, "profile": "/media/uploads/employee/dp/user-dp_qZogoYc.jpeg", "id": 70 }, { "name": "Test Team (Jithin)", "won": 0, "lost": 0, "pending": 0, "total": 0, "profile": "/media/uploads/employee/dp/308bc46fabaa2a90cf5822b64e2a2a28.jpg", "id": 1 }]
            ...
            <ScrollView style={{ flex: 1 }}>
                <View style={{ flex: 1, backgroundColor: lightGrey, paddingHorizontal: 20 }}>
                    <View style={{ flexDirection: "row", height: 40, }}>
                        <View style={{
                            marginTop: 10, justifyContent: 'center', flex: 0.5, height: 35, borderRadius: 50, backgroundColor: mainWhite, alignSelf: 'center'
                        ...
                        <View style={{
                            ...
                            <ModalDropdown
                                ...
                                <View style={{ alignItems: 'center', flexDirection: 'row' }}>
                                    <View style={{ flex: 5 }}>
                                        <Text style={{ color: mainGrey, fontSize: 14, paddingLeft: 5 }} >{selectedMon}</Text>
                                    </View>
