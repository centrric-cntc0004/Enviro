...
const ForkMaintenance = ({ navigation, data ,vehicledata, forklift_maintanace_list,
    ...
    const RenderContacts = () => {
        ...
        const delete_api = (id) => {
           ...
           const call_api = (id)=>{
            ...
            fork_delete_data(data, functions)
...
const mapDispatchToProps = (dispatch) => {
    return {
        // delete_vehicle: (vehicle_id, success, failed, page) => dispatch(__delete_vehicle(vehicle_id, success, failed, page))
      }
}

export default connect(mapStateToProps, mapDispatchToProps) (ForkMaintenance)
