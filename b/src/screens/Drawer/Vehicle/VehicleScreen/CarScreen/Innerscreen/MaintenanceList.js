...
import { fetch_maintanace_list1 } from '../common/action'
            ...
            return (
                ...
                <TouchableOpacity 
                    ...
                    <View style={{ flexDirection: 'row', flex: 1, backgroundColor: mainWhite, marginTop: 10, marginLeft: 5, marginRight: 5, }}>
                        ...
                        <View style={{ flex: 3.5, marginLeft: 10, marginRight: 10, flexDirection: 'column', }}>
...
export default connect(mapStateProps, mapDispatchToProps)(MaintenanceList)
