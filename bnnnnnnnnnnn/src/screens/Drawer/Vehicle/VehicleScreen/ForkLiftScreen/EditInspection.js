...
import { mainWhite, darkGrey, mainGrey, lightGrey, mainBlue, mediumGrey, mainBlack, textBlack, textRed } from '../../../../../common/Colors'
 ...
 import ReviewData from './InnerScreen/ReviewDatas'
...
const EditInspection = ({ navigation, vehicledata ,route,all_truck_list}) => {
    ...
    const RenderContacts = () => {
        ...
        if(route.params.items){
         ...
         action_taken=route.params.items.action_taken
        ...
        const [isCheck30, setCheck30] = useState(safe_ready_to_operate)
        const [isCheck31, setCheck31] = useState(reported_faults)
        ...
        const [signature, setSignature] = useState(signatures)
        ...
        style={{ paddingLeft: 5, alignSelf: 'center', color: mainGrey,fontSize:14 }}>{date}</Text>
                    ...
                    <View style={{ flex: 1, backgroundColor: lightGrey, flexDirection: 'column', marginTop: 30 }}>
                        ...
                        <View style={{ height: 30, backgroundColor: lightGrey, marginTop: 5, flexDirection: 'row' }}>
                            ...
                            <View style={{ flex: 0.5, backgroundColor: lightGrey }}>
                                <CheckBox checked={isCheck40} state={setCheck40} />
                            </View>
                        </View>
                        <View style={{ height: 30, backgroundColor: lightGrey, marginTop: 5, flexDirection: 'row' }}>
                            <View style={{ flex: 1.2, backgroundColor: lightGrey }}>
                            ...
                            <View style={{ flex: 0.5, backgroundColor: lightGrey }}>
                                <CheckBox checked={isCheck41} state={setCheck41} />
                            </View>
                        </View>
                        <View style={{ height: 30, backgroundColor: lightGrey, marginTop: 5, flexDirection: 'row' }}>
                            <View style={{ flex: 1.2, backgroundColor: lightGrey }}>
                            ...
                            <View style={{ flex: 0.5, backgroundColor: lightGrey }}>
                                <CheckBox checked={isCheck42} state={setCheck42} />
                            </View>
                        </View>
                        <View style={{ height: 30, backgroundColor: lightGrey, marginTop: 5, flexDirection: 'row' }}>
                            <View style={{ flex: 1.2, backgroundColor: lightGrey }}>
                            ...
                            <View style={{ flex: 0.5, backgroundColor: lightGrey }}>
                                <CheckBox checked={isCheck43} state={setCheck43} />
                            </View>
                        </View>
                        <View style={{ height: 30, backgroundColor: lightGrey, marginTop: 5, flexDirection: 'row' }}>
                            <View style={{ flex: 1.2, backgroundColor: lightGrey }}>
                            ...
                            <View style={{ flex: 0.5, backgroundColor: lightGrey }}>
                                <CheckBox checked={isCheck44} state={setCheck44} />
                            </View>
                        </View>
                        <View style={{ height: 30, backgroundColor: lightGrey, marginTop: 5, flexDirection: 'row' }}>
                            <View style={{ flex: 1.2, backgroundColor: lightGrey }}>
                            ...
                            <View style={{ flex: 0.5, backgroundColor: lightGrey }}>
                                <CheckBox checked={isCheck45} state={setCheck45} />
                            </View>
                        </View>
                    ...
                    style={{ paddingTop: 60, paddingBottom: 30, flex: 0.5, justifyContent: 'center', alignItems: 'center' }}>
                     ...
                     <ReviewData data={route.params.items} /> 
...
const mapStateProps = (state) => {
    ...
    console.log("kjkj"+JSON.stringify(state.vehicle__truck))
...
export default connect(mapStateProps,mapDispatchToProps) (EditInspection)
