...
import {
    ...
    VEHICLE_SEARCH,
    VEHICLE_CAR_MAINTANACE_EDIT,
    VEHICLE_CAR_MAINTANACE_DELETE
...
export const fetch_all_truck_list = () => {
    return function (dispatch) {
        let get_url = VEHICLE_ALL_GET + 'car/'
        Api('get', get_url)
            .then(response => {
...
export const fetch_maintanace_list = (page) => {
    ...
    return function (dispatch) {
        ...
        let get_url = VEHICLE_TRUCK_MAINTANACE_GET +'car/' + page + '/'
        Api('get', get_url)
            .then(response => {
                if (response.length > 0) {
...
export const __edit_maintanace = (maintanace_id, data, success, failed, page_no) => {
    return function (dispatch) {
        let edit_url = `${VEHICLE_CAR_MAINTANACE_EDIT + maintanace_id}/`
...
export const __delete_maintanace = (maintanace_id, success, failed, page_no) => {
    return function (dispatch) {
        ...
        let delete_url = `${VEHICLE_CAR_MAINTANACE_DELETE + maintanace_id}/`
...
export const fetch_fuel_list = (page) => {
    ...
    return function (dispatch) {
        ...
        let get_url = VEHICLE_TRUCK_FUEL_GET +'car/' + page + '/'
        Api('get', get_url)
            .then(response => {
                // console.log(response)
                if (response.length > 0) {
...
export const fetch_preinspection_list = () => {
    ...
    return function (dispatch) {
        ...
        let get_url = VEHICLE_TRUCK_PREINSPECTION +'car/'
