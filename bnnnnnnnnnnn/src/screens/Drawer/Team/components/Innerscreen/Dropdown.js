...
import { mainGrey,textBlack } from '../../../../../common/Colors'
import Icon from 'react-native-vector-icons/dist/FontAwesome5'
import ModalDropdown from 'react-native-modal-dropdown-v2'


const Dropdown = ({ dropdown_data, selectData,data }) => {
    let initial_value = ''
    if(data){
        initial_value = data
    }else
            ...
            <ModalDropdown
                ...
                <View style={{ alignItems: 'center', flexDirection: 'row' }}>
                    <View style={{ flex: 5 }}>
                        ...
                        style={{marginLeft:3, color: textBlack, fontSize: 14, paddingLeft: 5 }} >{selectedData}</Text>
                    </View>
