...
const InnerFolders = ({ navigation, route, team, dispatch }) => {
    ...
    const call_next = () => {
        // name = ""
        setName("")
        dispatch(certificate_list2(selected_employee.id,route.params.id))
        setItem("")
        setSection(1)
    }
...
export default connect(mapStateProps)(InnerFolders)
